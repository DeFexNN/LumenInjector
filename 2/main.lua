...
function HomeFunction()
  if logged then
    LayoutVIP2.addView(mWindow,WmHz2)
...
function mmw.OnTouchListener(v,event)
  if event.getAction()==MotionEvent.ACTION_DOWN then
   ...
   elseif event.getAction()==MotionEvent.ACTION_MOVE then
    ...
    LayoutVIP2.updateViewLayout(mWindow,WmHz2)
...
function bbw.OnTouchListener(v,event)
  if event.getAction()==MotionEvent.ACTION_DOWN then
   ...
   elseif event.getAction()==MotionEvent.ACTION_MOVE then
    ...
    LayoutVIP.updateViewLayout(bWindow,WmHz)
   elseif event.getAction()==MotionEvent.ACTION_UP then
  end return true
end
...
function close.onClick(v)
  if isMax==false then
    isMax=true
    LayoutVIP2.removeView(mWindow)
    LayoutVIP.addView(bWindow,WmHz)
   else
    isMax=false
    LayoutVIP.removeView(bWindow)
    LayoutVIP2.addView(mWindow,WmHz2)
  end
end
...
function Man.onClick()
  zip4j.unZipDir(
  activity.getLuaDir("/cpp/huligan/sleep.zip"),
  activity.getLuaDir("Files/"),
  "yki7wevwsaewng9sudwfgdcw1lfgci7p6ti")
  ExecuteELF("Files/sleep")
  ExecuteELF("Files/sleep2")
  Safe()
...
function cargo.onClick()
  if cargo.checked==true then
    zip4j.unZipDir(
    activity.getLuaDir("/cpp/huligan/cargo.zip"),
    activity.getLuaDir("Files/"),
    "yki7wevwsaewng9sudwfgdcw1lfgci7p6ti")
    ExecuteELF("Files/cargo")
    Safe()
  end
  if cargo.checked==false then
    zip4j.unZipDir(
    activity.getLuaDir("/cpp/huligan/cargo.zip"),
    activity.getLuaDir("Files/"),
    "yki7wevwsaewng9sudwfgdcw1lfgci7p6ti")
    ExecuteELF("Files/cargooff")
    Safe()
  end
end

function soul.onClick()
  if soul.checked==true then
    zip4j.unZipDir(
    activity.getLuaDir("/cpp/huligan/soul.zip"),
    activity.getLuaDir("Files/"),
    "yki7wevwsaewng9sudwfgdcw1lfgci7p6ti")
    ExecuteELF("Files/soul")
    Safe()
  end
  if soul.checked==false then
    zip4j.unZipDir(
    activity.getLuaDir("/cpp/huligan/soul.zip"),
    activity.getLuaDir("Files/"),
    "yki7wevwsaewng9sudwfgdcw1lfgci7p6ti")
    ExecuteELF("Files/souloff")
    Safe()
  end
end

function prohod.onClick()
  if prohod.checked==true then
    zip4j.unZipDir(
    activity.getLuaDir("/cpp/huligan/TroughWallsON.zip"),
    activity.getLuaDir("Files/"),
    "yki7wevwsaewng9sudwfgdcw1lfgci7p6ti")
    ExecuteELF("Files/TroughWallsON")
    Safe()
  end
  if prohod.checked==false then
    zip4j.unZipDir(
    activity.getLuaDir("/cpp/huligan/TroughWallsON.zip"),
    activity.getLuaDir("Files/"),
    "yki7wevwsaewng9sudwfgdcw1lfgci7p6ti")
    ExecuteELF("Files/TroughWallsOFF")
    Safe()
  end
end
...
function fastfarm.onClick()
  zip4j.unZipDir(
  activity.getLuaDir("/cpp/huligan/farm.zip"),
  activity.getLuaDir("Files/"),
  "yki7wevwsaewng9sudwfgdcw1lfgci7p6ti")
  ExecuteELF("Files/farm")
  Safe()
end

function high.onClick()
  if high.checked==true then
    zip4j.unZipDir(
    activity.getLuaDir("/cpp/huligan/high.zip"),
    activity.getLuaDir("Files/"),
    "yki7wevwsaewng9sudwfgdcw1lfgci7p6ti")
    ExecuteELF("Files/high")
    Safe()
  end
  if high.checked==false then
    zip4j.unZipDir(
    activity.getLuaDir("/cpp/huligan/high.zip"),
    activity.getLuaDir("Files/"),
    "yki7wevwsaewng9sudwfgdcw1lfgci7p6ti")
    ExecuteELF("Files/highoff")
    Safe()
  end
end

function long.onClick()
  if long.checked==true then
    zip4j.unZipDir(
    activity.getLuaDir("/cpp/huligan/long.zip"),
    activity.getLuaDir("Files/"),
    "yki7wevwsaewng9sudwfgdcw1lfgci7p6ti")
    ExecuteELF("Files/long")
    Safe()
  end
  if high.checked==false then
    zip4j.unZipDir(
    ...
    activity.getLuaDir("Files/"),
    "yki7wevwsaewng9sudwfgdcw1lfgci7p6ti")
    ExecuteELF("Files/longoff")
    Safe()
  end
end

function fastknife.onClick()
  if long.checked==true then
    zip4j.unZipDir(
    activity.getLuaDir("/cpp/huligan/fastknife.zip"),
    activity.getLuaDir("Files/"),
    "yki7wevwsaewng9sudwfgdcw1lfgci7p6ti")
    ExecuteELF("Files/fastknife")
    Safe()
  end
  if high.checked==false then
    zip4j.unZipDir(
